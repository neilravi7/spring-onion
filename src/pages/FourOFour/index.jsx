...
function FourOFour(props) {
  ...
  const {isAuthenticated, isVendor, isCustomer} = useSelector((state) => state.auth);
  console.log("404", isAuthenticated, isVendor, isCustomer);
